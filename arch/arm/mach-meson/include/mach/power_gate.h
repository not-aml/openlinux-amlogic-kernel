...
#define GCLK_IDX_MEDC_CLK_PIC_DC         42
#define GCLK_NAME_MEDC_CLK_PIC_DC      "MEDC_CLK_PIC_DC"
#define GCLK_DEV_MEDC_CLK_PIC_DC      "CLKGATE_MEDC_CLK_PIC_DC"
#define GCLK_REG_MEDC_CLK_PIC_DC      (HHI_GCLK_MPEG1)   
#define GCLK_MASK_MEDC_CLK_PIC_DC      (1<<27)
