...
static struct resource bt656in_resources[] = {
    ...
    [2] = {			//bt601 input resource pin mux setting
...
static struct i2c_board_info board_i2c_info[] = {
	{
        I2C_BOARD_INFO("fq1216me-tuner", 0xC2),
	},
	{
...
static void __init board_init_i2c(void)
{
	i2c_register_board_info(0, board_i2c_info, ARRAY_SIZE(board_i2c_info));
}
...
MACHINE_START(MESON2_7366M, "AMLOGIC MESON-M2 7366M")
